// clang++ -g -O3 my-lang.cpp `llvm-config --cxxflags --ldflags --system-libs --libs core orcjit native` -rdynamic -o mylang
...
// BinopPrecedence - This holds the precedence for each defined binary operator.
